# -*- coding: utf-8 -*-
"""AAPL_M1_VOLUME.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1xYeF3MQUXEZ7gJu6phiHczTHr8dnu2ud
"""
...
class SleepyRedOrangeSalamander(QCAlgorithm):
    def initialize(self):
        ...
        # Indicadores
        self.atr = self.ATR(self.symbol, 10000, Resolution.MINUTE)
        self.atr2 = self.ATR(self.symbol, 1, Resolution.MINUTE)
    ...
    def on_data(self, data: Slice):
        ...
        if self.previous_low is not None and not self.trade:
            if close > self.sma_daily.Current.Value and close < self.previous_low and atr_value2 > atr_value * 10:
                self.set_holdings(self.symbol, 1)
                self.trade = True

                self.entry_price = self.Portfolio[self.symbol].AveragePrice
                self.stop_price = self.entry_price - atr_value2
